...
//	RestTemplate is a Spring class used for making HTTP requests. It simplifies communication with external APIs by handling many tasks like opening connections, handling HTTP methods, etc.
...
//			Here, mapper.readValue is used to deserialize the JSON response into a Java List<Coin>
