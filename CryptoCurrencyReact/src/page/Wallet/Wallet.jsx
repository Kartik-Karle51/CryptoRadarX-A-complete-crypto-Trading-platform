...
import { CopyIcon, DollarSign, DownloadIcon, ReceiptIcon, ShuffleIcon, UploadIcon, WalletIcon } from "lucide-react";
...
const handleFetchWalletTransaction = () => {
    dispatch(getWalletTransactions({ jwt: localStorage.getItem("jwt") }))
        .then((response) => {
            console.log("Fetched Transactions:", response); // Debugging API response
        })
        .catch((error) => {
